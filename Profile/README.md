...
Nosso foco é criar soluções que promovam:

Transparência financeira;
Organização entre moradores;
Facilidade no controle de contas;
Redução de conflitos relacionados a pagamentos.
...
Fórmula de cálculo:
Valor Individual = Valor Total da Despesa / Número de Moradores
